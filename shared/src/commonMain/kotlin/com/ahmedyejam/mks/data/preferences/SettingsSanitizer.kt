...
/**
 * Normalizes theme mode strings to valid enum values.
 */
fun normalizeMksThemeMode(value: String?): String =
    when (value?.uppercase()) {
        "DAWN", "MIDNIGHT", "FOREST", "LAVENDER", "PLAIN_LIGHT", "PLAIN_DARK", "SYSTEM" -> value.uppercase()
        else -> "DAWN"
    }
